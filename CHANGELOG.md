...
* **core:** ensure setting active injector in child module ([#1268](https://github.com/formly-js/ngx-formly/issues/1268)) ([84e7b71](https://github.com/formly-js/ngx-formly/commit/84e7b71)), closes [#1240](https://github.com/formly-js/ngx-formly/issues/1240)


### Features

* **core:** initial support OnPush CD ([#1267](https://github.com/formly-js/ngx-formly/issues/1267)) ([a874e09](https://github.com/formly-js/ngx-formly/commit/a874e09))


### Performance Improvements

* **core:** markForCheck only changed fields ([#1269](https://github.com/formly-js/ngx-formly/issues/1269)) ([44c25c9](https://github.com/formly-js/ngx-formly/commit/44c25c9))
...
* **core:** check expression change only when expression is set ([f30ac9a](https://github.com/formly-js/ngx-formly/commit/f30ac9a))
...
* **core:** remove passing model value to FormGroup ([#1021](https://github.com/formly-js/ngx-formly/issues/1021)) ([f0f7e2c](https://github.com/formly-js/ngx-formly/commit/f0f7e2c))
...
* **core:** allow specify the target of a validation error ([d2105f7](https://github.com/formly-js/ngx-formly/commit/d2105f7)), closes [#1007](https://github.com/formly-js/ngx-formly/issues/1007)
...
* **core:** avoid duplicate templateManipulator wrapper during rebuild ([291d214](https://github.com/formly-js/ngx-formly/commit/291d214)), closes [#997](https://github.com/formly-js/ngx-formly/issues/997)
...
* add grouped select support when binding observables ([0f903c7](https://github.com/formly-js/ngx-formly/commit/0f903c7))



<a name="4.0.3"></a>
## [4.0.3](https://github.com/formly-js/ngx-formly/compare/v4.0.2...v4.0.3) (2018-05-15)


### Bug Fixes

* **core:** export FormlyTemplateOptions ([7953c1d](https://github.com/formly-js/ngx-formly/commit/7953c1d)), closes [#950](https://github.com/formly-js/ngx-formly/issues/950)
...
* **core:** ensure parsers is working again ([#933](https://github.com/formly-js/ngx-formly/issues/933)) ([3a3e478](https://github.com/formly-js/ngx-formly/commit/3a3e478))
...
* **core:** avoid reset parent form when resetting model. ([#783](https://github.com/formly-js/ngx-formly/issues/783)) ([1757193](https://github.com/formly-js/ngx-formly/commit/1757193))
...
* **core:** ensure passing a string path for FormGroup. ([#666](https://github.com/formly-js/ngx-formly/issues/666)) ([f5f2378](https://github.com/formly-js/ngx-formly/commit/f5f2378)), closes [#665](https://github.com/formly-js/ngx-formly/issues/665)
...
* **bootstrap:** ensure to set a string value when select is not multiple. ([#602](https://github.com/formly-js/ngx-formly/issues/602)) ([6c591f8](https://github.com/formly-js/ngx-formly/commit/6c591f8)), closes [#601](https://github.com/formly-js/ngx-formly/issues/601)
