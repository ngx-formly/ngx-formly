        ...
        data: {
          examples: [{
            ...
            files: [
              ...
              { file: 'custom-input.component.ts', content: require('!!highlight-loader?raw=true&lang=typescript!./custom-input.component.ts'), filecontent: require('!!raw-loader!./custom-input.component.ts') },
            ],
          }],
        },
      },
