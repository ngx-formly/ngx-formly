        ...
        data: {
          examples: [{
            ...
            files: [
              ...
              { file: 'panel-wrapper.component.ts', content: require('!!prismjs-loader?lang=typescript!./panel-wrapper.component.ts'), filecontent: require('!!raw-loader?lang=typescript!./panel-wrapper.component.ts') },
