        ...
        data: {
          examples: [{
            ...
            files: [
              ...
              { file: 'panel-wrapper.component.ts', content: require('!!highlight-loader?raw=true&lang=typescript!./panel-wrapper.component.ts'), filecontent: require('!!raw-loader!./panel-wrapper.component.ts') },
