        ...
        data: {
          examples: [{
            ...
            files: [
              ...
              { file: 'file-value-accessor.ts', content: require('!!prismjs-loader?lang=typescript!./file-value-accessor.ts') },
              { file: 'file-type.component.ts', content: require('!!prismjs-loader?lang=typescript!./file-type.component.ts') },
