        ...
        data: {
          examples: [{
            ...
            files: [
              ...
              { file: 'button-type.component.ts', content: require('!!prismjs-loader?lang=typescript!./button-type.component.ts'), filecontent: require('!!raw-loader?lang=typescript!./button-type.component.ts') },
