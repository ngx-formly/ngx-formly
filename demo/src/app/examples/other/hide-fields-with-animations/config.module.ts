        ...
        data: {
          examples: [{
            ...
            files: [
              ...
              { file: 'animation-wrapper.component.ts', content: require('!!prismjs-loader?lang=typescript!./animation-wrapper.component.ts'), filecontent: require('!!raw-loader?lang=typescript!./animation-wrapper.component.ts') },
