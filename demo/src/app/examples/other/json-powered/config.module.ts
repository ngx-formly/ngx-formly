        ...
        data: {
          examples: [{
            ...
            files: [
              ...
              { file: 'user.service.ts', content: require('!!prismjs-loader?lang=typescript!./user.service.ts') },
              { file: 'user.json', content: require('!!prismjs-loader?lang=typescript!../../../../assets/json-powered/user.json') },
              { file: 'user-form.json', content: require('!!prismjs-loader?lang=typescript!../../../../assets/json-powered/user-form.json') },
