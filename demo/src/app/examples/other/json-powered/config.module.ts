        ...
        data: {
          examples: [{
            ...
            files: [
              ...
              { file: 'assets/json-powered/user.json', content: require('!!prismjs-loader?lang=typescript!../../../../assets/json-powered/user_json'), filecontent: require('!!raw-loader?lang=typescript!../../../../assets/json-powered/user_json') },
              { file: 'assets/json-powered/user-form.json', content: require('!!prismjs-loader?lang=typescript!../../../../assets/json-powered/user-form_json'), filecontent: require('!!raw-loader?lang=typescript!../../../../assets/json-powered/user-form_json') },
