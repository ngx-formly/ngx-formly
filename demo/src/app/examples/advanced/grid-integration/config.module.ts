        ...
        data: {
          examples: [{
            ...
            files: [
              ...
              { file: 'grid.type.ts', content: require('!!highlight-loader?raw=true&lang=typescript!./grid.type.ts'), filecontent: require('!!raw-loader!./grid.type.ts') },
              { file: 'grid-formly-cell.component.ts', content: require('!!highlight-loader?raw=true&lang=typescript!./grid-formly-cell.component.ts'), filecontent: require('!!raw-loader!./grid-formly-cell.component.ts') },
            ],
          }],
        },
      },
