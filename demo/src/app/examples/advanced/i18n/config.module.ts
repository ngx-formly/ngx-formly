        ...
        data: {
          examples: [{
            ...
            files: [
              ...
              { file: 'assets/i18n/en.json', content: require('!!prismjs-loader?lang=typescript!./assets/en_json'), filecontent: require('!!raw-loader?lang=typescript!./assets/en_json') },
              { file: 'assets/i18n/fr.json', content: require('!!prismjs-loader?lang=typescript!./assets/fr_json'), filecontent: require('!!raw-loader?lang=typescript!./assets/fr_json') },
            ],
          }],
        },
      },
