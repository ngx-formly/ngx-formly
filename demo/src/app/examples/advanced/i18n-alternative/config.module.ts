        ...
        data: {
          examples: [{
            ...
            files: [
              ...
              { file: 'translate.extension.ts', content: require('!!highlight-loader?raw=true&lang=typescript!./translate.extension.ts'), filecontent: require('!!raw-loader!./translate.extension.ts') },
              { file: 'assets/i18n/en.json', content: require('!!highlight-loader?raw=true&lang=typescript!@assets/i18n/en_json'), filecontent: require('!!raw-loader!@assets/i18n/en_json') },
              { file: 'assets/i18n/fr.json', content: require('!!highlight-loader?raw=true&lang=typescript!@assets/i18n/fr_json'), filecontent: require('!!raw-loader!@assets/i18n/fr_json') },
            ],
          }],
        },
      },
