        ...
        data: {
          examples: [{
            ...
            files: [
              ...
              { file: 'horizontal-wrapper.ts', content: require('!!highlight-loader?raw=true&lang=typescript!./horizontal-wrapper.ts'), filecontent: require('!!raw-loader!./horizontal-wrapper.ts') },
            ],
          }],
        },
      },
