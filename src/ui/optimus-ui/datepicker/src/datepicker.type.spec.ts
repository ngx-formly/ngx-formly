...
import { FormlyDatepickerModule } from '@ngx-formly/optimus-ui/datepicker';
...
describe('ui-optimus-ui: Date Picker Type', () => {
  it('should render datepicker type', () => {
    ...
    expect(query('formly-wrapper-optimus-ui-form-field')).not.toBeNull();
  });
