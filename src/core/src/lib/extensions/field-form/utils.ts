...
import { UntypedFormArray, UntypedFormGroup, UntypedFormControl, AbstractControl } from '@angular/forms';
...
export function registerControl(
  ...
  if (!(isNil(control.value) && isNil(value)) && control.value !== value && control instanceof UntypedFormControl) {
